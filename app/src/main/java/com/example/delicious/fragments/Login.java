...
public class Login extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button registerBtn =view.findViewById(R.id.signupButton);
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                            ...
                            .addOnCompleteListener(requireActivity(), new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Navigation.findNavController(view).navigate(R.id.action_login_to_homePage3);
                                    } else {
                    ...
                    Toast.makeText(getContext(), "Email and password must be filled", Toast.LENGTH_SHORT).show();
                }
            }
    });
